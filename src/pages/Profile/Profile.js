            ...
            <div className="profileSetting-form">
              <section>
                <p>
                  ...
                  <input name="name" type="text" value={userInfo.name} onChange={e => onChangeHandler(e)} />
                </p>
                <p>
              ...
              <section>
                <p>
                  ...
                  <input name="phoneNumber" type="number" value={userInfo.phoneNumber} onChange={e => onChangeHandler(e)} />
                </p>
                <p>
                ...
                <p>
                  ...
                  <input name="pincode" type="number" value={userInfo.pincode} onChange={e => onChangeHandler(e)} />
                </p>
              </section>
              <section>
                <p>
                  <label htmlFor="city"><GiModernCity />City</label>
                  <input name="city" type="text" value={userInfo.city} onChange={e => onChangeHandler(e)} />
                </p>
                <p>
              ...
              <section>
                ...
                <p>
                  ...
                  <input name="landmark" type="text" value={userInfo.landmark} onChange={e => onChangeHandler(e)} />
                </p>
              </section>
            </div>
            {!saveButton ?
