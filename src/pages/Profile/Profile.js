...
const Profile = () => {
  ...
  return (
    <>
      {userInfo.name === undefined || userState.loading ? (
        <RingLoader />
      ) : (
              ...
              <section>
                ...
                <p>
                  ...
                  <input
                    ...
                    type="number"
                    value={
                      userInfo.secondaryPhoneNumber === null
                        ? ""
                        : userInfo.secondaryPhoneNumber
                    }
                    onChange={(e) => onChangeHandler(e)}
                  />
                </p>
